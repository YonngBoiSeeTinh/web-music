        ...
        return (
            <div className="sub-menu">
                ...
                <div className="sub-menu-3">
                    ...
                    <Link to={`/userPage`}  style={{ display: isSignIn ? 'flex' : 'none' }}>{user.name}</Link>
                    
                    <div className="login">
                    <Link to="#" onClick={handleOpenLogin}  style={{ display: isSignIn ? 'none' : 'flex' }}>Đăng nhập</Link>
                    </div> 
                    <div className="register">
                    <Link to="#" onClick={handleOpenSignUp}  style={{ display: isSignIn ? 'none' : 'flex' }}>Đăng ký</Link>
                    </div>
                </div>
                {showLogin && (
